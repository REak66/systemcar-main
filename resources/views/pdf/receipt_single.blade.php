...
<head>
    ...
    <style>
        ...
        .byd-badge { display: inline-block; background: #dc2626; color: #fff; font-weight: bold; font-size: 20px; padding: 2px 7px; letter-spacing: 4px; line-height: 1.1; margin-right: 10px; vertical-align: top; }
        ...
        .doc-title { text-align: center; margin: 5px 0 4px; }
        ...
        hr { border: none; border-top: 1px solid #6b7280; margin: 5px 0 8px; }
        ...
        .stages { border: 1px solid #9ca3af; padding: 5px 10px; margin-bottom: 12px; }
        ...
        .sig-sub { margin-bottom: 28px; }
        .sig-line { border-top: 1px solid #9ca3af; padding-top: 4px; margin-top: 0; }
    </style>
</head>
<body>
