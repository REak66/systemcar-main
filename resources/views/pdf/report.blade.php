...
<body>
    ...
    <table style="width:auto;margin-bottom:16px;">
        <tr>
            ...
            <td style="padding:4px 12px;border:1px solid #bfdbfe;font-weight:bold;">{{ number_format($vatTotal, 2) }}
            </td>
        </tr>
    </table>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="9" style="text-align:center;color:#999;">No receipts</td>
                </tr>
                @endforelse
            </tbody>
            @if($receipts->count())
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                @php if ($inv->currency === 'USD') $inv_usd += $inv->grand_total; else $inv_khr += $inv->grand_total;
                @endphp
                <tr>
                    <td>{{ $i + 1 }}</td>
                ...
                @empty
                <tr>
                    <td colspan="11" style="text-align:center;color:#999;">No invoices</td>
                </tr>
                @endforelse
            </tbody>
            @if($invoices->count())
    ...
    <div class="footer">Cashier Management Car System</div>
</body>
