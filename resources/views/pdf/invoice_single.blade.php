...
<head>
    ...
    <style>
        ...
        .company-wrap { display: inline-block; vertical-align: top; text-align: center; }
        .company-name { font-weight: bold; font-size: 12px; line-height: 1.3; }
        .company-sub { color: #4b5563; font-size: 9px; line-height: 1.4; }
        hr { border: none; border-top: 1px solid #6b7280; margin: 5px 0 6px; }
        .doc-title { text-align: center; position: relative; margin: 6px 0; }
        .doc-title-kh { font-size: 11px; font-weight: bold; }
        .doc-title-en { font-size: 13px; font-weight: bold; letter-spacing: 3px; text-transform: uppercase; }
        .doc-no { position: absolute; top: 0; right: 0; font-size: 9px; }
        table.info { width: 100%; border-collapse: collapse; border: 1px solid #9ca3af; margin-bottom: 0; }
        table.info td { padding: 4px 8px; font-size: 9.5px; }
        table.info .label { color: #4b5563; }
        table.stages { width: 100%; border-collapse: collapse; border: 1px solid #9ca3af; border-top: none; margin-bottom: 12px; }
        table.stages td { padding: 5px 10px; }
        .stage-item { display: inline-block; margin-right: 18px; font-size: 9.5px; }
        .checkbox { display: inline-block; width: 12px; height: 12px; border: 1px solid #4b5563; text-align: center; line-height: 11px; font-size: 9px; vertical-align: middle; margin-right: 3px; }
        table.items { width: 100%; border-collapse: collapse; border: 1px solid #9ca3af; }
        table.items th { border: 1px solid #9ca3af; padding: 5px 4px; text-align: center; font-size: 9px; }
        table.items td { border-left: 1px solid #9ca3af; border-right: 1px solid #9ca3af; padding: 4px 5px; font-size: 9.5px; }
        table.items td.center { text-align: center; }
        table.items td.right { text-align: right; white-space: nowrap; }
        table.items tfoot td { border: 1px solid #9ca3af; padding: 5px 7px; font-size: 9.5px; }
        .bank-info { margin-top: 10px; font-size: 9.5px; line-height: 1.7; }
        .bank-info .label { color: #4b5563; margin-right: 6px; }
        .signatures { display: table; width: 100%; margin-top: 36px; }
        .sig-block { display: table-cell; text-align: center; width: 50%; font-size: 9.5px; vertical-align: top; }
        .sig-line { border-top: 1px solid #9ca3af; padding-top: 4px; margin-top: 28px; }
    </style>
</head>
<body>
    ...
    <div class="header">
        <div class="header-left">
            ...
            <div class="company-wrap">
                ...
                <div class="company-sub">Address: Lot No 52 Phum Derntkov, S. Chroychongva, K. Chroychongva, Phnum Penh</div>
        ...
        <tfoot>
            @if($invoice->with_vat)
                <tr>
                    ...
                    <td class="right">{{ $invoice->currency === 'KHR' ? '៛' : '$' }} {{ number_format($invoice->vat_amount, 2) }}</td>
                </tr>
            @endif
            <tr>
