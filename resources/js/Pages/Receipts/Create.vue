          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input :value="form.receipt_number" type="text" readonly
                  class="w-full border border-slate-200 bg-gray-50 rounded-lg px-3 py-2.5 text-sm font-mono text-blue-700" />
              </div>
              <div>
          ...
          <div>
            ...
            <div class="space-y-4">
              <div>
                ...
                <p v-if="form.errors.payment_category" class="text-red-600 text-xs mt-1">{{ form.errors.payment_category
                }}
                </p>
              </div>
              <div>
